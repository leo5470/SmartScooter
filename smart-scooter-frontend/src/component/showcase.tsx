...
interface prop {
    text: string
    textLocation: Array<number>
    modelName: string
    modelScale: number
    modelRotation: Array<number>
    modelLocation: Array<number>
}
export default function Showcase(props: prop) {
            ...
            <section>
                <div style={{ "aspectRatio": 2.4 }}>
                    <Canvas shadows camera={{ position: [5, 0, 15], fov: 30 }}>
                        ...
                        <Text3D position={props.textLocation} font="./font/tech_font.json">
                            {props.text}
                        </Text3D>
                        <Model modelName={props.modelName} scale={props.modelScale} position={props.modelLocation} rotation={props.modelRotation} />
...
function Model(props) {
    const { scene } = useGLTF(`/3d/${props.modelName}.glb`)
