...
export class User extends PhysicalObject {
    constructor(user_id: number, location: Location, public username: string, public credit_card: string|null, public coupons: number, public is_admin: boolean, public telephone_number: string|null, public email: string) {
